...
const configuracionPlanificacionRoutes = require('./configuracionPlanificacionRoutes');
const usuarioRoutes = require('./usuarioRoutes');
const distribucionRoutes = require('./distribucionRoutes');
const planificacionCarreraRoutes = require('./planificacionCarreraRoutes');
...
router.use('/configuracion-planificacion', configuracionPlanificacionRoutes);
router.use('/usuarios', usuarioRoutes);
router.use('/distribucion', distribucionRoutes);
router.use('/planificacion-colaborativa', planificacionCarreraRoutes);
